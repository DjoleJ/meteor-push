const sendNotification = (isDebug, fcmConnections, defaults, userToken, mongoNote) => {
  ...
  console.log('noteAndroidData:', noteAndroidData);
  console.log('noteIosDate:', noteIosData);
  console.log('noteWebDate:', noteWebData);
  console.log('globalData:', globalData);

  const gData = globalData || {};
  gData['image'] = mongoNote.imageUrl || defaults.imageUrl;
