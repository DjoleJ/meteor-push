...
Push.Configure = serverConfig => {
  ...
  console.log('fcmConnections:', fcmConnections);
  if (serverConfig.firebaseAdmin) {
    console.log('firebaseAdmin:', serverConfig.firebaseAdmin);
    ...
    console.log('Firebase Admin for Android Messsaging has not been configured');
  }
